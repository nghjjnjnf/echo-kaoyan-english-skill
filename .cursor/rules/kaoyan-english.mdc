---
description: Use for 考研英语真题、英一、英二、阅读、阅读理解、阅读 Text、阅读全文翻译、阅读原文翻译、完形全文翻译、完型全文翻译、重点词汇、固定搭配、完形、完型、翻译、作文批改、考研英语模拟题、模拟阅读、模拟完形、模拟完型、外刊出题、外刊改编、VOA 阅读、抓取文章、生成练习、保存练习记录、答案依据和错题复盘。
globs:
alwaysApply: false
---
